...
const IconSelecType = props => (
  ...
  >
    ...
    <title>welcome</title>
    <rect x="69" width="731" height="731" fill="#5b52fc" opacity="0.2" />
    <rect x="179" y="68.25" width="510" height="595.5" fill="#5b52fc" opacity="0.5" />
    ...
    <rect x="604" y="113" width="255" height="506" fill="#5b52fc" />
    <rect x="175" y="197.5" width="255" height="506" transform="translate(439 816.5) rotate(-180)" fill="#5b52fc" />
    ...
    <rect x="137" y="649" width="594" height="30" fill="#5b52fc" />
    <rect x="134" y="50" width="602" height="39" fill="url(#5f8c78d2-e119-41dc-88f5-5bfd3b7b4286)" />
    <rect x="137" y="53" width="594" height="30" fill="#5b52fc" />
