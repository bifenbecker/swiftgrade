...
class TotalNumberGradedAnswersSchema(BaseSwaggerSchema):
    def get_summary_and_description(self):
        return None, "Returns the information for the statistics chart which displays the number of graded answers " \
                     "according to the provided answer type and date period in days."
    ...
    def get_response_serializers(self):
        return {
            ...
            "400": openapi.Schema(type=openapi.TYPE_OBJECT, properties=OrderedDict((
                ("errors", openapi.Schema(type=openapi.TYPE_STRING, default="Incorrect answer type.")),
            )),)
        }
