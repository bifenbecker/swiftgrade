...
class ActiveTeachersWithResultsSchema(BaseSwaggerSchema):
    def get_summary_and_description(self):
        return None, "Returns the information for the statistics chart which displays the numbers of active teachers " \
                     "who have at least one student result for any of the current teacher assessments " \
                     "according to the provided date period in days."
