...
class CompletedAssessmentsListSchema(BaseSwaggerSchema):
    def get_summary_and_description(self):
        return None, "Returns a list of completed assessments for a specific group to a user with the role of student."
    ...
    def _get_schema(self):
        assessments = self.serializer_to_schema(CompletedAssessmentsListSerializer())
